...
* **Interface chung:** [IBaseService](file://Common/src/main/java/com/common/service/contract/IBaseService.java) định nghĩa các thao tác CRUD cơ bản và phân trang.
* **Implementation cho JPA (SQL):** [BaseServiceImpl](file://Common/src/main/java/com/common/service/impl/BaseServiceImpl.java).
* **Implementation cho MongoDB (NoSQL):** [BaseMongoServiceImpl](file://Common/src/main/java/com/common/service/impl/BaseMongoServiceImpl.java).
