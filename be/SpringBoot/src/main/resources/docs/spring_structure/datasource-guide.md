...
- **JPA (
  SQL):** [BaseModel](file://Common/src/main/java/com/common/model/sql/BaseModel.java) —
  audit fields cơ bản
- **MongoDB (
  NoSQL):** [BaseModel](file://Common/src/main/java/com/common/model/nosql/BaseModel.java)

#### Tùy chọn Xóa Mềm (Soft Delete)

- **JPA (
  SQL):** [BaseSoftDeleteModel](file://Common/src/main/java/com/common/model/sql/BaseSoftDeleteModel.java)
- **MongoDB (
  NoSQL):** [BaseSoftDeleteModel](file://Common/src/main/java/com/common/model/nosql/BaseSoftDeleteModel.java)
...
| Entity                                                                                                                       | Mô tả                              |
|------------------------------------------------------------------------------------------------------------------------------|------------------------------------|
| [OutboxEvent](file://Common/src/main/java/com/common/model/sql/OutboxEvent.java)             | Transactional Outbox Pattern       |
| [SystemSetting](file://Common/src/main/java/com/common/model/sql/SystemSetting.java)         | Cấu hình hệ thống động             |
| [DynamicGridConfig](file://Common/src/main/java/com/common/model/sql/DynamicGridConfig.java) | Cấu hình bảng động render trên web |
| [DynamicGridColumn](file://Common/src/main/java/com/common/model/sql/DynamicGridColumn.java) | Cấu hình từng cột của bảng động    |
