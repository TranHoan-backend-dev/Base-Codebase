...
Dự án Client muốn sử dụng Elasticsearch cần thêm annotation [@EnableCommonElasticsearch](file://Common/src/main/java/com/common/config/elasticsearch/EnableCommonElasticsearch.java) vào class khởi chạy chính:
