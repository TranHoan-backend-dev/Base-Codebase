...
1. **Entity:** [SystemSetting](file://Common/src/main/java/com/common/model/sql/SystemSetting.java) quản lý key, value và mô tả cấu hình.
2. **Service:** [ISystemSettingService](file://Common/src/main/java/com/common/service/contract/ISystemSettingService.java) cung cấp các phương thức CRUD và tìm kiếm tối ưu.
