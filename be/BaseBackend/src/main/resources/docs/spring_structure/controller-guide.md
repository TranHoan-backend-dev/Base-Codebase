...
Hệ thống Base Controller được định nghĩa tại class abstract: [BaseController](file:////Base-Codebase/Common/src/main/java/com/common/controller/BaseController.java).
