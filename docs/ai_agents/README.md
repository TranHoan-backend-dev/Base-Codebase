...
| 5 | **Code Sync Agent** | Đồng bộ DTO/Entity từ Java BE sang TypeScript interfaces/types cho FE | 📄 [code-sync.md](file:///d:/Du_an_ca_nhan/Base-Codebase/docs/ai_agents/code-sync.md) |
| 6 | **Changelog Generator** | Phân tích Git history và xuất file Release Notes chuẩn Markdown | 📄 [changelog-generator.md](file:///d:/Du_an_ca_nhan/Base-Codebase/docs/ai_agents/changelog-generator.md) |
| 7 | **Security Scan Agent** | Quét hardcoded secrets, rò rỉ `.env`, CORS wildcard và CSP headers | 📄 [security-scan.md](file:///d:/Du_an_ca_nhan/Base-Codebase/docs/ai_agents/security-scan.md) |
