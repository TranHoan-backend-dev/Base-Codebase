...
1. **Phase 1: NPM Audit**: Chạy `npm audit --json` trên `nextjs-base` và `nuxtjs-base`.
2. **Phase 2: Maven Dependency Analysis**: Chạy `mvn dependency:analyze` trên `BaseBackend`.
