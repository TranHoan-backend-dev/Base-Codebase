...
<PackageManagers
  commands={{
    npm: "npm install @internationalized/date@3.12.0",
    yarn: "yarn add @internationalized/date@3.12.0",
    pnpm: "pnpm add @internationalized/date@3.12.0",
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @internationalized/date@3.12.0 @react-aria/i18n@3.12.16",
    yarn: "yarn add @internationalized/date@3.12.0 @react-aria/i18n@3.12.16",
    pnpm: "pnpm add @internationalized/date@3.12.0 @react-aria/i18n@3.12.16",
  }}
/>
